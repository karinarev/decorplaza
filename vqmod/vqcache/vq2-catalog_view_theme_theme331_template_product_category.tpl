...
<?php echo $column_left; ?>
	 ...
	 <?/*<div class="sort cat_arr"> <b>КАТЕГОРИИ:</b> 
      ...
      <select onchange="location = this.value;">
        ...
        <?php foreach ($catArr as $item) { ?>		
			<? if ($item['path'] == $this->request->get['path']) { ?>
				<option selected<?php if($item['category_id'] == $this->request->get['catId']) echo 'selected="selected"' ?> value="<?php echo $item['href']; ?>"><?php echo $item['name']; ?></option>	
			<? } else { ?>
			...
			<?php foreach ($item['children'] as $value) { ?>
				<? if ($value['path'] == $this->request->get['path']) { ?>
					<option selected <?php if($value['category_id'] == $this->request->get['catId']) echo 'selected="selected"' ?> value="<?php echo $value['href']; ?>"><?php echo $value['name']; ?></option>		   
				<? } else { ?>
  ...
  <div class="product-grid">
	<ul class="row">
		...
		<div itemscope itemtype="http://schema.org/Product"  class="padding">
		
		<?php if ($product['thumb']) { ?>
		<div class="image"><a href="<?php echo $product['href']; ?>"><img itemprop="image id="img_<?php echo $product['product_id']; ?>" src="<?php echo $product['thumb']; ?>" title="<?php echo $product['name']; ?>" alt="<?php echo $product['name']; ?>" /></a>
		...
		<?php } ?>
		<?php if (!$product['special']) { ?>
		<?php echo str_replace('р.', ' </span>р.', $product['price']);  ?>
