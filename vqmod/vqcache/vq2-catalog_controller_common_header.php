...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['description'] = utf8_substr(strip_tags(html_entity_decode($this->document->getDescription(), ENT_QUOTES, 'UTF-8')), 0, 250) . '';
		
		//$product_info1 = $this->model_catalog_product->getProduct($product_id);
		//$this->data['description1'] = $product_info1['description'];
		...
		$mobilecategories = $this->model_catalog_category->getCategories(0);
		foreach ($mobilecategories as $mobilecategorie) {
			if ($mobilecategorie['parent_id'] == 0) {
				// Level 2
				$children_data = array();
				
				$children = $this->model_catalog_category->getCategories($mobilecategorie['category_id']);
				...
				// Level 1
				$this->data['mobilecategories'][] = array(
					'name'     => $mobilecategorie['name'],
					'children' => $children_data,
					'column'   => $mobilecategorie['column'] ? $mobilecategorie['column'] : 1,
					'href'     => $this->url->link('product/category', 'path=' . $mobilecategorie['category_id']),
					'category_id' => $mobilecategorie['category_id']
				);
			}
		}
