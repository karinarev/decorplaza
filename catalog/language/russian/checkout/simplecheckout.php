...
$_['text_checkout_customer_login']   = 'Вход для зарегистрированых';
...
$_['error_coupon']                   = 'Ошибка: скидочный код либо недействителен, либо истек срок его действия, либо достигнут предел его использования.<br>Если Вы являетесь обладателем дисконтной карты, но при вводе ее номера скидка не рассчитывается, то скорее всего она не активирована. Для активации карты пройдите по этой ссылке - <a href="/index.php?route=discount/discountcart">Активировать карту</a>';
