...
$_['text_logged']                    = '<a href="%s">Вход под %s</a><a href="%s">/Выход</a>';
...
$_['text_payment_until_canceled_description'] = '%s каждый %d %s(s) пока не закончится';
$_['text_day']                       = 'день';
$_['text_week']                      = 'неделя';
...
$_['entry_telephone']                = 'Телефон мобильный:';
$_['entry_fax']                      = 'Телефон городской:';
$_['entry_company']                  = 'Компания:';
$_['entry_customer_group']           = 'Тип деятельности:';
$_['entry_company_id']               = 'Код компании:';
$_['entry_tax_id']                   = 'ИНН:';
$_['entry_address_1']                = 'Улица/номер дома';
$_['entry_address_2']                = '№ квартиры/этаж/домофон:';
...
$_['text_trial']                    = '%s каждый %s %s для %s платежей ';
