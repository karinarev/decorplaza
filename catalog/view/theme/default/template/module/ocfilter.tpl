  ...
  <div class="box-content">
    ...
    <form action="">
      ...
      <!--  <div class="option-name">
        ...
        <?php if ($manual_price) { ?>
				<div class="fields-price4" id="fields-price-<?php echo $module; ?>">
				Цена:
					<?php echo $symbol_left; ?>&nbsp;<input name="price[min]" value="<?php echo $min_price_get; ?>" type="text" size="6" id="min-price-value-<?php echo $module; ?>" style="height:20px; width:50px; font-size:11px;" />&nbsp;-&nbsp;<input name="price[max]" value="<?php echo $max_price_get; ?>" type="text" size="6" id="max-price-value-<?php echo $module; ?>" style="height:20px; width:50px; font-size:11px;" />&nbsp;<?php echo $symbol_right; ?>
				</div>
				<?php } ?>
