...
<div class="simplecheckout-customer-block">
    ...
    <div>
        ...
        <div class="simplecheckout-customer-right">
    ...
    <div class="simple_table_row" <?php echo !empty($field['place']) ? 'place="'.$field['place'].'"' : '' ?>>
    <div <?php echo $user_choice && $split_previous ? 'class="simple-header-right"' : ''; ?>>
    ...
    <div id="password_row" <?php echo $simple_customer_generate_password ? ' style="display:none;"' : '' ?> <?php echo $simple_customer_generate_password ? 'autogenerate="1"' : '' ?>>
    <div class="simplecheckout-customer-left">
        <span class="simplecheckout-required">*</span>
...
<div id="confirm_password_row" <?php echo $simple_customer_generate_password ? ' style="display:none;"' : '' ?> <?php echo $simple_customer_generate_password ? 'autogenerate="1"' : '' ?>>
<div class="simplecheckout-customer-left">
    <span class="simplecheckout-required">*</span>
...
<?php } else { ?>
<?php if (($field['id'] == 'main_telephone') || ($field['id'] == 'main_zone_id') || ($field['id'] == 'main_city')) { ?>
<!--<div class="row simple_table_row <?php echo !empty($field['selector']) ? ' simple-geo-selector-customer' : '' ?>" <?php echo !empty($field['place']) ? 'place="'.$field['place'].'"' : '' ?><?php echo !empty($field['selector']) ? ' style="display:none;"' : '' ?>>
-->
<div class="cart-label col-md-6">
    <?php if ($field['required']) { ?>
    <span class="simplecheckout-required">*</span>
...
<!--  </div> -->
<?php } else { ?>
<div class="simple_table_row <?php echo !empty($field['selector']) ? ' simple-geo-selector-customer' : '' ?>" <?php echo !empty($field['place']) ? 'place="'.$field['place'].'"' : '' ?><?php echo !empty($field['selector']) ? ' style="display:none;"' : '' ?>>
<div class="cart-label simple-row">
    <?php if ($field['required']) { ?>
    <span class="simplecheckout-required">*</span>
    <?php } ?>
...
<div id="simple_geo_selector_customer">
...
<div id="subscribe_row"<?php echo $simple_customer_action_register == Simple::REGISTER_USER_CHOICE && !$register && !$simple_customer_view_email ? ' style="display:none;"' : '' ?>>
<div class="simplecheckout-customer-left">
...
<span class="important-mark">*Поля, обязательные для заполнения</span>
<script type="text/javascript"><!--

    $('#checkout_customer_main_zone_id').styler({
