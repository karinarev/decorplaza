			...
			<div class="row">
				...
				<div class="col-sm-8">
					...
					<div class="other_links">
						<i class="fa fa-truck"></i> <a href="http://perun-shop.ru/dostavka">Информация о доставке</a>
						<i class="fa fa-credit-card"></i> <a href=" http://perun-shop.ru/oplata">Информация об оплате</a>
					</div>
				</div>
			</div>
			...
			<div class="tabs">
				...
				<script type="text/javascript">
					$(document).ready(function(){
						$('meta[name="description"]').attr('content', '<?php echo $description."<br>".$description2;  ?>');
					});
				</script>
				...
				echo('<div class="box"><div class="box-heading">Похожие товары</div></div>');
					foreach ($products_analog as $product_analog) {
						echo('<div class="analog">');
							...
							echo('<div class="name"><a href="'.$product_analog['url'].'">'.$product_analog['name'].'</a></div>');
							echo('<div class="priceanalog">'.$product_analog['price'].' р.</div>');
							echo('<a class="button-prod" href="'.$product_analog['url'].'">Подробнее</a>
									...
									<form class="add_to_cart" method="post">
										...
										<input class="q-mini" type="hidden" name="product_id" size="2" value="<?php echo $product_analog['product_id']; ?>" />
											...
											<input id="product_name" type="hidden" value="<?php echo $product_analog['name']; ?>">
														...
														<select class="selectare" name="option[<?php echo $product_analog['product_id']; ?>]">
										...
										<br />
										<?php } ?>
										<?php if ($option_value['type'] == 'checkbox') { ?>
										<div id="option-<?php echo $option_value['product_option_id']; ?>" class="option">
										  <label><?php if ($option_value['required']) { ?>
										  <span class="required">*</span>
										  <?php } ?>
										  <b><?php echo $option_value['name']; ?>:</b></label>
										  <?php foreach ($option_value['option_value'] as $option_value) { ?>
										  
										  <label class="checkbox" for="option-value-<?php echo $option_value['product_option_value_id']; ?>"><input type="checkbox" name="option[<?php echo $option_value['product_option_id']; ?>][]" value="<?php echo $option_value['product_option_value_id']; ?>" id="option-value-<?php echo $option_value['product_option_value_id']; ?>" /><?php echo $option_value['name']; ?>
											<?php if ($option_value['price']) { ?>
											(<?php echo $option_value['price_prefix']; ?><?php echo $option_value['price']; ?>)
											<?php } ?>
										  </label>
										...
										<div id="option-<?php echo $option_value['product_option_id']; ?>" class="option">
										  ...
										  <?php echo $option_value['name']; ?>:</label>
											<table class="option-image">
											  <?php foreach ($option_value['option_value'] as $option_value) { ?>
											  <tr>
												<td style="width: 1px;"><input type="radio" name="option[<?php echo $option_value['product_option_id']; ?>]" value="<?php echo $option_value['product_option_value_id']; ?>" id="option-value-<?php echo $option_value['product_option_value_id']; ?>" /></td>
										...
										<div id="option-<?php echo $option_value['product_option_id']; ?>" class="option">
										  ...
										  <?php } ?>
										  <?php echo $option_value['name']; ?>:</label>
										  <input type="text" name="option[<?php echo $option_value['product_option_id']; ?>]" value="<?php echo $option_value['option_value']; ?>" />
										</div>
										<?php } ?>
										<?php if ($option_value['type'] == 'textarea') { ?>
										<div id="option-<?php echo $option_value['product_option_id']; ?>" class="option">
										 <label><?php if ($option_value['required']) { ?>
										  <span class="required">*</span>
										  <?php } ?>
										  <?php echo $option_value['name']; ?>:</label>
										  <textarea name="option[<?php echo $option_value['product_option_id']; ?>]" cols="40" rows="5"><?php echo $option_value['option_value']; ?></textarea>
										</div>
										<?php } ?>
										<?php if ($option_value['type'] == 'file') { ?>
										<div id="option-<?php echo $option_value['product_option_id']; ?>" class="option">
										  <label><?php if ($option_value['required']) { ?>
										  <span class="required">*</span>
										  <?php } ?>
										  <?php echo $option_value['name']; ?>:</label>
										  <a id="button-option-<?php echo $option_value['product_option_id']; ?>" class="btn"><?php echo $button_upload; ?></a>
										  <input type="hidden" name="option[<?php echo $option_value['product_option_id']; ?>]" value="" />
										</div>
										<br />
										<?php } ?>
										<?php if ($option_value['type'] == 'date') { ?>
										<div id="option-<?php echo $option_value['product_option_id']; ?>" class="option">
										  <label><?php if ($option_value['required']) { ?>
										  <span class="required">*</span>
										  <?php } ?>
										  <?php echo $option_value['name']; ?>:</label>
										  <input type="text" name="option[<?php echo $option_value['product_option_id']; ?>]" value="<?php echo $option_value['option_value']; ?>" class="date" />
										</div>
										<br />
										<?php } ?>
										<?php if ($option_value['type'] == 'datetime') { ?>
										<div id="option-<?php echo $option_value['product_option_id']; ?>" class="option">
										  <label><?php if ($option_value['required']) { ?>
										  <span class="required">*</span>
										  <?php } ?>
										  <?php echo $option_value['name']; ?>:</label>
										  <input type="text" name="option[<?php echo $option_value['product_option_id']; ?>]" value="<?php echo $option_value['option_value']; ?>" class="datetime" />
										</div>
										<br />
										<?php } ?>
										<?php if ($option_value['type'] == 'time') { ?>
										<div id="option-<?php echo $option_value['product_option_id']; ?>" class="option">
										  <label><?php if ($option_value['required']) { ?>
										  <span class="required">*</span>
										  <?php } ?>
										  <?php echo $option_value['name']; ?>:</label>
										  <input type="text" name="option[<?php echo $option_value['product_option_id']; ?>]" value="<?php echo $option_value['option_value']; ?>" class="time" />
										</div>
										<br />
										<?php } ?>
										<?php } ?>
											...
											<div class="wishlist"><a class="tooltip-1 " title="<?php echo $button_wishlist; ?>"  onclick="addToWishList('<?php echo $product_analog['product_id']; ?>');"><i class="fa fa-star"></i></a></div>
											<div class="compare"><a class="tooltip-1" title="<?php echo $button_compare; ?>"  onclick="addToCompare('<?php echo $product_analog['product_id']; ?>');"><i class="fa fa-bar-chart-o"></i></a></div>
											<div class="clear"></div>
										</div>
