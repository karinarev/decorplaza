	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<li><a href="<?php echo $information['href']; ?>"><?php echo $information['title']; ?></a></li>
				<?php } ?>
						<li><a class="<?php if (isset($this->request->get['route']) && $this->request->get['route']=="information/contact") {echo "active";} ?>" href="<?php echo $contact; ?>"><i class="fa fa-star"></i><?php echo $text_contact; ?></a></li>
