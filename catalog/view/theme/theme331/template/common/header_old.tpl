		...
		<div class="row">
			<div class="col-sm-12">
				<?php if ($logo) { ?>
					...
					<img class="img" style="vertical-align:top;max-width:100%;width:100%;" src="<?php echo $logo; ?>" title="<?php echo $name; ?>" alt="Staly-Sumochka – кожаные сумки из Италии" /></a>
				...
				<div class="rightsearch">
				 ...
				 <div style="font-size:12px; font-weight:bold;   color: #EC1313;">Бесплатный звонок по России</div>
					<ul>
						 <li>
							<span><a style="font-size: 22px;   color: #EC1313;" href="tel:88005555555">8 (800) 555-55-55</a></span>
						</li>
						<li>
                	        <span><a style="font-size: 22px;"  href="tel:84955555555">8 (495) 555-55-55</a></span>
						</li>
						<li>
                     	    <span><a style="font-size: 22px;"  href="tel:89265555555">8 (926) 555-55-55</a></span>
						</li>
				...
				<!--<div class="phonemobil">
				 <div style="font-size:12px; font-weight:bold;   color: #EC1313;">Бесплатный звонок по России</div>
					<ul>
						 <li>
							<a style="font-size: 22px;   color: #EC1313;" href="tel:+78005555555" >8 (800) 555-55-55</a>
						</li>
						<li>
                	        <a style="font-size: 22px;" href="tel:+74954907474" >8 (495) 555-55-55</a>
						</li>
						<li>
				...
				<div class="grafik-addres">
					...
					<a class="feedbackForm" href="#yandexmapmodal"><div class="addres" >
						ул. Большая Новодмитровская, д. 23
					</div></a>
