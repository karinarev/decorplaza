		...
		<div class="content">
		  <table class="form">      
			...
			<tr>
				<td>
					<div class="form-group">
						<label class="control-label col-sm-5" for="telephone"><?php echo $entry_telephone; ?></label>
						<div class="controls col-sm-7">
		...
		<div class="content">
		  <table class="form">
			...
			<tr>
				<td>
					<div class="form-group">
						<label class="control-label col-sm-5" for="address_1"><?php echo $entry_address_1; ?></label>
						<div class="controls col-sm-7">
			...
			<tr>
				<td>
					<div class="form-group">
						<label class="control-label col-sm-5" for="city"><?php echo $entry_city; ?></label>
						<div class="controls col-sm-7">
