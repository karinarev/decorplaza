...
<link href="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/stylesheet/info.css" rel="stylesheet" type="text/css" />
  ...
  <h1 class="myHeader"><?php echo $heading_title; ?></h1>
