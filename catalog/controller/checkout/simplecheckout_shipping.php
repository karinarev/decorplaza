...
class ControllerCheckoutSimpleCheckoutShipping extends Controller {
    public function index() {
           ...
           if ($this->data['address_empty'] && !empty($simple_shipping_view_address_full[$result['code']])) {
            ...
            if ($this->config->get($result['code'] . '_status') && $show_module) {
                ...
                if (empty($for_payment_methods) || ($payment_method_code && in_array($payment_method_code, $for_payment_methods))) {
					...
					if(($quote['code'] == 'ems' && $this->data['address']['city'] == 'Москва') OR ($quote['code'] == 'ems' && $this->data['address']['zone_id'] == 2761)) continue;
					if(($quote['code'] == 'flat' && $this->data['address']['city'] == 'Москва') OR ($quote['code'] == 'flat' && $this->data['address']['zone_id'] == 2761)) continue;
					if(($quote['code'] == 'citylink' && $this->data['address']['city'] != 'Москва') OR ($quote['code'] == 'citylink' && $this->data['address']['zone_id'] != 2761)) continue;
                    if (($result['code'] == 'pochtaros' && $this->data['address']['city'] == 'Москва') OR ($quote['code'] == 'pochtaros' && $this->data['address']['zone_id'] == 2761)) continue;

					//if($quote['code'] == 'citylink' && $this->data['address']['city'] != 'Москва') continue;				
       ...
       // array_multisort($sort_order, SORT_ASC, $quote_data);
        ...
        $array = $this->data['shipping_methods'];
