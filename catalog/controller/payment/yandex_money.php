...
//		$this->data['action'         ] = $this->url->link('payment/yandex_money/getPaymentForm');
		$this->data['action'         ] = 'index.php?route=payment/yandex_money/getPaymentForm';
	...
	public function getPaymentForm () {
		if (isset ($this->session->data['order_id'])) {
			...
			if (!$this->data['setting']['course']) {
				$rur_order_total = $this->currency->convert($order_info['total'], $order_info['currency_code'], 'RUB');
			} else {
				$rur_order_total = (float)$order_info['total'] * (float)$this->data['setting']['course'];
			};
