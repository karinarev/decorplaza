...
class ControllerSaleCoupon extends Controller {
	...
	public function insertcoupons() {
  	...
  	protected function getList() {
		...
		$this->data['insertcoupons'] = $this->url->link('sale/coupon/insertcoupons', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$this->data['button_insertcoupons'] = 'Добавить серию купонов';
	...
	protected function getSeriaForm() {
    	$this->data['heading_title'] = $this->language->get('heading_title');
		...
		$this->data['entry_name'] = $this->language->get('entry_serya_name');
    	$this->data['entry_description'] = $this->language->get('entry_description');
    	$this->data['entry_code'] = $this->language->get('entry_code');
		$this->data['entry_code1'] = $this->language->get('entry_code1');
		...
		if (isset($this->error['code1'])) {
			$this->data['error_code1'] = $this->error['code1'];
		} else {
			$this->data['error_code1'] = '';
		}	
		...
		if (!isset($this->request->get['coupon_id'])) {
			$this->data['action'] = $this->url->link('sale/coupon/insertcoupons', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
		...
		$this->template = 'sale/coupon_seria_form.tpl';
		$this->children = array(
			'common/header',	
			'common/footer'	
		);
  	...
  	protected function validateForm() {
		...
		if (isset($this->request->post['code1'])) {	
			if ((utf8_strlen($this->request->post['code1']) < 3) || (utf8_strlen($this->request->post['code1']) > 10) || (utf8_strlen($this->request->post['code2']) < 3) || (utf8_strlen($this->request->post['code2']) > 10)) {
