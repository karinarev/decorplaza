...
class ControllerPaymentYandexMoney extends Controller {
	...
	public function index() {
		...
		$this->data['entry_course'    	  ] = $this->language->get('entry_course');
	...
	private function validate() {
		...
		if (isset ($this->request->post['yandex_money_setting'])) {
			...
			if ($this->request->post['yandex_money_setting']['course'])
			$this->request->post['yandex_money_setting']['course'] = (float) $this->request->post['yandex_money_setting']['course'];
