...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$this->data['entry_discount_form'] = $this->language->get('entry_discount_form');
		...
		if (isset($this->request->post['config_discount_form'])) {
			$this->data['config_discount_form'] = $this->request->post['config_discount_form'];
		} else {
			$this->data['config_discount_form'] = $this->config->get('config_discount_form');
		}
