...
class ControllerCatalogManufacturer extends Controller { 
	private $error = array();
  	...
  	protected function getForm() {
    	...
    	if (isset($this->request->post['manufacturer_id_boxing'])) {
      		$this->data['manufacturer_id_boxing'] = $this->request->post['manufacturer_id_boxing'];
    	} elseif (!empty($manufacturer_info)) {
			$this->data['manufacturer_id_boxing'] = $manufacturer_info['manufacturer_id_boxing'];
		} else {
      		$this->data['manufacturer_id_boxing'] = '';
    	}
