...
class ControllerCatalogCategory extends Controller { 
	...
	protected function getForm() {
		...
		$this->data['entry_namer'] = $this->language->get('entry_namer');
		$this->data['entry_namev'] = $this->language->get('entry_namev');
		$this->data['entry_named'] = $this->language->get('entry_named');
		$this->data['entry_sinonim1'] = $this->language->get('entry_sinonim1');
		$this->data['entry_sinonim2'] = $this->language->get('entry_sinonim2');
		...
		if (isset($this->error['namer'])) {
			$this->data['error_namer'] = $this->error['namer'];
		} else {
			$this->data['error_namer'] = array();
		}
		
		if (isset($this->error['namev'])) {
			$this->data['error_namev'] = $this->error['namev'];
		} else {
			$this->data['error_namev'] = array();
		}
		
		if (isset($this->error['named'])) {
			$this->data['error_named'] = $this->error['named'];
		} else {
			$this->data['error_named'] = array();
		}
		
		if (isset($this->error['sinonim1'])) {
			$this->data['error_sinonim1'] = $this->error['sinonim1'];
		} else {
			$this->data['error_sinonim1'] = array();
		}
		
		if (isset($this->error['sinonim2'])) {
			$this->data['error_sinonim2'] = $this->error['sinonim2'];
		} else {
			$this->data['error_sinonim2'] = array();
		}
		...
		if (isset($this->request->post['category_description'])) {
			...
			$this->data['category_id_boxing'] = $this->data['category_description']['category_id_boxing'];
		} else {
			$this->data['category_description'] = array();
			$this->data['category_id_boxing'] = 0;
		}
		...
		if (isset($this->request->post['image_size'])) {
			...
			$this->data['image_size'] = $category_info['image_size'];
		} else {
		...
		if (isset($this->request->post['image_size']) && file_exists(DIR_IMAGE . $this->request->post['image_size'])) {
			$this->data['thumb_size'] = $this->model_tool_image->resize($this->request->post['image_size'], 100, 100);
		} elseif (!empty($category_info) && $category_info['image_size'] && file_exists(DIR_IMAGE . $category_info['image_size'])) {
			$this->data['thumb_size'] = $this->model_tool_image->resize($category_info['image_size'], 100, 100);
		} else {
			$this->data['thumb_size'] = $this->model_tool_image->resize('no_image.jpg', 100, 100);
		}
		...
		if (isset($this->request->post['category_id_boxing'])) {
			$this->data['category_id_boxing'] = $this->request->post['category_id_boxing'];
		} elseif (!empty($category_info)) {
			$this->data['category_description']['category_id_boxing'] = $category_info['category_description']['category_id_boxing'];
		} else {
			$this->data['category_description']['category_id_boxing'] = 0;
		}
	...
	protected function validateForm() {
		...
		foreach ($this->request->post['category_description'] as $language_id => $value) {
			...
			if ((utf8_strlen($value['namer']) < 2) || (utf8_strlen($value['namer']) > 255)) {
				$this->error['namer'][$language_id] = $this->language->get('error_namer');
			}
			if ((utf8_strlen($value['namev']) < 2) || (utf8_strlen($value['namev']) > 255)) {
				$this->error['namev'][$language_id] = $this->language->get('error_namev');
			}
			if ((utf8_strlen($value['named']) < 2) || (utf8_strlen($value['named']) > 255)) {
				$this->error['named'][$language_id] = $this->language->get('error_named');
			}
			if ((utf8_strlen($value['sinonim1']) < 2) || (utf8_strlen($value['sinonim1']) > 255)) {
				$this->error['sinonim1'][$language_id] = $this->language->get('error_sinonim1');
			}
			if ((utf8_strlen($value['sinonim2']) < 2) || (utf8_strlen($value['sinonim2']) > 255)) {
				$this->error['sinonim1'][$language_id] = $this->language->get('error_sinonim2');
			}
