...
class ControllerCatalogProduct extends Controller {
	...
	public function filter() {
  	...
  	protected function getForm() {
		...
		if (isset($this->error['functions'])) {
			$this->data['error_functions'] = $this->error['functions'];
		} else {
			$this->data['error_functions'] = array();
		}
 		...
 		if (isset($this->error['meta_description'])) {
   		...
   		if (isset($this->error['description2'])) {
			...
			$this->data['error_description2'] = array();
		}	
		...
		if (isset($this->request->post['export'])) {
      		$this->data['export'] = $this->request->post['export'];
    	} elseif (!empty($product_info)) {
      		$this->data['export'] = $product_info['export'];
    	} else {
			$this->data['export'] = 1;
		}

		if (isset($this->request->post['newItem'])) {
      		$this->data['newItem'] = $this->request->post['newItem'];
    	} elseif (!empty($product_info)) {
      		$this->data['newItem'] = $product_info['newItem'];
    	} else {
			$this->data['newItem'] = 1;
		}
		if (isset($this->request->post['bestSaller'])) {
      		$this->data['bestSaller'] = $this->request->post['bestSaller'];
    	} elseif (!empty($product_info)) {
      		$this->data['bestSaller'] = $product_info['bestSaller'];
    	} else {
			$this->data['bestSaller'] = 1;
		}
		
		if (isset($this->request->post['bestSeller'])) {
      		$this->data['bestSeller'] = $this->request->post['bestSeller'];
    	} elseif (!empty($product_info)) {
      		$this->data['bestSeller'] = $product_info['bestSeller'];
    	} else {
			$this->data['bestSeller'] = 1;
		}
