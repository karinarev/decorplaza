      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          <table class="form">
            ...
            <tr>
              <td><span class="required">*</span> <?php echo $entry_code1; ?></td>
              <td>с <input type="text" name="code1" value="<?php echo $code; ?>" /> по <input type="text" name="code2" value="<?php echo $code; ?>" />
                <?php if ($error_code1) { ?>
                <span class="error"><?php echo $error_code1; ?></span>
                <?php } ?></td>
            </tr>
            <tr>
