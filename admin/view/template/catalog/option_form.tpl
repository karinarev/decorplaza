        ...
        <table id="option-value" class="list">
          <thead>
            <tr>
              ...
              <td class="left">Id на boxing-kipa</td>
          ...
          <tbody id="option-value-row<?php echo $option_value_row; ?>">
            <tr>
              <td class="left"><input type="hidden" name="option_value[<?php echo $option_value_row; ?>][option_value_id]" value="<?php echo $option_value['option_value_id']; ?>" />
                ...
                <?php } ?>
                <?php } ?></td>
              <td class="left"><input type="text" name="option_value[<?php echo $option_value_row; ?>][option_value_id_boxing]" value="<?php echo $option_value['option_value_id_boxing']; ?>" size="4" /></td>  
...
function addOptionValue() {
    ...
    <?php } ?>
	html += '    </td>';
  html += '    <td class="left"><input type="text" name="option_value[' + option_value_row + '][option_value_id_boxing]" value="" size="4" /></td>';
