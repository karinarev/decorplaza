        ...
        <div id="tab-general">
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
			  ...
			  <tr>
                <td><span class="required"></span> <?php echo $entry_functions; ?></td>
                <td><input type="text" name="product_description[<?php echo $language['language_id']; ?>][functions]" maxlength="255" size="100" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['functions'] : ''; ?>" />
                  <?php if (isset($error_functions[$language['language_id']])) { ?>
                  <span class="error"><?php echo $error_functions[$language['language_id']]; ?></span>
                  <?php } ?></td>
              </tr>
        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
              ...
              <td><input type="checkbox" name="export" value="1" <?php if($export>0) echo 'checked'; ?> size="2" /></td>
            </tr>
            <tr>
              <td>Новинка</td>
              <td><input type="checkbox" name="newItem" value="1" <?php if($newItem>0) echo 'checked'; ?> size="2" /></td>
            </tr>
            <tr>
              <td>Товар дня</td>
              <td><input type="checkbox" name="bestSaller" value="1" <?php if($bestSaller>0) echo 'checked'; ?> size="2" /></td>
            </tr>
			       <tr>
              <td>Лидер продаж</td>
              <td><input type="checkbox" name="bestSeller" value="1" <?php if($bestSeller>0) echo 'checked'; ?> size="2" /></td>
            </tr>
          </table>
        </div>
        <div id="tab-links">
          ...
          <div id="tab-option-<?php echo $option_row; ?>" class="vtabs-content">
            ...
            <table class="form">
              ...
              <tr style="display: none;">
                <td><?php echo $entry_option_value; ?></td>
                <td><input type="text" name="product_option[<?php echo $option_row; ?>][option_value]" multiple value="<?php echo $product_option['option_value']; ?>" /></td>
              </tr>
              <?php } ?>
