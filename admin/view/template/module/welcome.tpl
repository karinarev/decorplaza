      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-module-<?php echo $module_row; ?>" class="vtabs-content">
          ...
          <div id="tab-language-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>">
            <table class="form">
                <tr>
                    <td><?php echo $entry_first_title; ?></td>
                    <td><input name="welcome_module[<?php echo $module_row; ?>][first-title][<?php echo $language['language_id']; ?>]" id="first-title-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>" value="<?php echo isset($module['first-title'][$language['language_id']]) ? $module['first-title'][$language['language_id']] : ''; ?>" ></td>
                </tr>
                <tr>
                    <td><?php echo $entry_second_title; ?></td>
                    <td><input name="welcome_module[<?php echo $module_row; ?>][second-title][<?php echo $language['language_id']; ?>]" id="second-title-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>" value="<?php echo isset($module['second-title'][$language['language_id']]) ? $module['second-title'][$language['language_id']] : ''; ?>" ></td>
                </tr>
              <tr>
...
function addModule() {	
    ...
    html += '        <tr>';
    html += '          <td><?php echo $entry_first_title; ?></td>';
    html += '          <td><input name="welcome_module[' + module_row + '][first-title][<?php echo $language['language_id']; ?>]" id="first-title-' + module_row + '-<?php echo $language['language_id']; ?>"/></td>';
    html += '        </tr>';
    html += '        <tr>';
    html += '          <td><?php echo $entry_second_title; ?></td>';
    html += '          <td><textarea name="welcome_module[' + module_row + '][second-title][<?php echo $language['language_id']; ?>]" id="second-title-' + module_row + '-<?php echo $language['language_id']; ?>"/></td>';
    html += '        </tr>';
	html += '        <tr>';
