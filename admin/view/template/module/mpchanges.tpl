            ...
            <table class="form" id="filter">
                <tr>
                    ...
                    <div class="vtabs">
                        ...
                        <a href="#del_section" style="display: none;">
                         ...
                         <a href="#weight" style="display: none;">
                            <?php echo $tab_weight; ?>
                        </a>
                        <a href="#status" style="display: none;">
                            <?php echo $tab_status; ?>
                        </a>
                        <a href="#name" style="display: none;">
                            <?php echo $tab_name; ?>
                        </a>
                    </div>
                    ...
                    <div id="weight" class="vtabs-content">
                        <form action="<?php echo $action_change_weight; ?>" method="post" enctype="multipart/form-data" id="form_change_weight">
                            <table class="form">
                                <tr>
                                    <td><?php echo $entry_weight; ?></td>
                                    <td colspan="2">
                                        <select name="weight_diff">
                                            <option value="-">-</option>
                                            <option value="+">+</option>
                                            <option value="*">*</option>
                                            <option value="/">/</option>
                                        ...
                                        <input type="text" name="manufacturer_weight" value=""/>
                                        <select name="change_type">
                                            <option value="percent"><?php echo $label_percent; ?></option>
                                            <option value="number"><?php echo $label_number; ?></option>
                                        </select>
                                ...
                                <tr>
                                    <td>
                                        <div class="buttons">
                                            <a class="button submit-form" data-form="form_change_weight"><?php echo $button_change_weight; ?></a>
                                        </div>
                                    </td>
                    ...
                    <div id="status" class="vtabs-content">
                        <form action="<?php echo $action_change_status; ?>" method="post" enctype="multipart/form-data" id="form_change_status">
                            <table class="form">
                                <tr>
                                ...
                                <tr>
                                    <td>
                                        <div class="buttons">
                                            <a class="button submit-form" data-form="form_change_status"><?php echo $button_change_status; ?></a>
                                        </div>
                                    </td>
                    ...
                    <div id="name" class="vtabs-content">
                        <form action="<?php echo $action_change_name; ?>" method="post" enctype="multipart/form-data" id="form_change_name">
                            <table class="form">
                                <tr>
                                    <td><?php echo $entry_old_name; ?></td>
                                    <td colspan="2">
                                        <input type="text" name="manufacturer_old_name" value="">
                                        
                                        
                                    </td>
                                </tr>
                                <tr>
                                    <td><?php echo $entry_new_name; ?></td>
                                    <td colspan="2">
                                        <input type="text" name="manufacturer_new_name" value="">
                                ...
                                <tr>
                                    <td>
                                        <div class="buttons">
                                            <a class="button submit-form" data-form="form_change_name"><?php echo $button_change_name; ?></a>
                                        </div>
                                    </td>
                ...
                <tr>
                    <td colspan="3">
                        ...
                        <div class="scrollbox" id="check-all" style="height: 22px; width: 100%; background: #B7D7F5; cursor:pointer;"><input type="checkbox" checked="checked" name="change_all" value="true" /> Все товары</div>
