...
<div class="control-group">
    ...
    <label class="checkbox"><input type="checkbox" value="1" name="csv_import[skip_category]"<?php if($csv_import['skip_category']) echo ' checked';?> /> <?php echo $text_import_skip; ?></label><input type="hidden" name="csv_import[skip_category_check]" value="">
