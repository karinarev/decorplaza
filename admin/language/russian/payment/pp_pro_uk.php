...
$_['entry_partner']      = 'Партнер:<br /><span class="help">ID партнера в системе PayPal, который зарегестрировал Вас в Payflow SDK. Если счет открыт непосредственно в системе PayPal, используйте PayPalUK.</span>';
...
$_['error_vendor']       = 'Необходимо указать продавца!'; 
$_['error_user']         = 'Необходимо указать пользователя!'; 
$_['error_password']     = 'Необходимо указать пароль!'; 
$_['error_partner']      = 'Необходимо указать партнера!'; 
?>
